...
1. Clone repository: 
    ````
    git clone https://nikrgl.informatik.tu-ilmenau.de/students/jowa3080-person-reidentification.git
    ````
...
3. Data Preparation
    ...
    one. Pleas note that each path should match the corresponding dataset name (order is important).
